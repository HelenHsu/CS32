...
void order(double a[], int n)
{
	...
	order(a,firstNotGreater);		//larger part
	order(a+firstLess,n-firstLess);		//smaller part
    	return; 
}
///////////////////////////////////////////////////////////////////////////////
int main()
{
	double b[8]={1,5,4,2,5,4,3};
	double b1[3]={5,4,3};
	double b2[3]={1,4,3};
	assert(countIncludes(b,7,b1,3)==3);
	assert(countIncludes(b,7,b2,3)==2);
	double a[11]={3,8,7,1,2,5,6,7,9,4};
	order(a,10);
	for(int i=0;i<10;i++)
		cerr<<a[i];
	cerr<<endl;
