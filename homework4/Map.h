...
////////////////////////////////////////////////////////////////////////////
//summery:
//to change the original Map into a template Map
//
//move all implement file into header file
//add template<typename c1,typename c2> before inline or all memberfunction
//add <c1,c2> after every class name
//ie. Map<c1,c2>::f(){};
//add typename to avoid confustion for dependent constructor, 
//ie. typename Map<c1,c2>::Map(const ..., const...)
//but not for default constructor,
//ie.  Map<c1,c2>::Map() also destructor
////////////////////////////////////////////////////////////////////////////
