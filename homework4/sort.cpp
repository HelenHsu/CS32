...
int main()
{
	...
	vector<Sensor*>::iterator itP=auxSensorsPtr.begin();
	vector<Sensor>::iterator it=sensors.begin();
	for(; itP!=auxSensorsPtr.end();itP++)
	{	*it=**itP;
		it++;
	}	
